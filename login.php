                  ...
                  <form name="form1" method="post" action="checklogin.php" onSubmit="return loginValidate(this)" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text"  class="form-control" name="myusername" id="myusername" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="mypassword" class="form-control" id="mypassword" value="" required>
